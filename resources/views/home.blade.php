...
<section class="slide1">
  <div class="wrap-slick1">
    <div class="slick1">
      ...
      <div class="item-slick1 item2-slick1" style="background-image: url({{asset('images/banner/banner2.jpg')}});">
        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
      ...
      <div class="item-slick1 item3-slick1" style="background-image: url({{asset('images/banner/banner3.jpg')}});">
        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
      ...
      <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
        <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
          ...
          <div class="ab-t-l sizefull flex-col-c-b p-l-15 p-r-15 p-b-20">
            <div class="t-center">
              <a href="{{asset('assets/product-detail.html')}}" class="dis-block s-text3 p-b-5">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
        <!-- Block3 -->
        <div class="block3">
          <a href="{{asset('assets/blog-detail.html')}}" class="block3-img dis-block hov-img-zoom">
            <img src="{{asset('assets/images/blog-01.jpg')}}" alt="IMG-BLOG">
          </a>

          <div class="block3-txt p-t-14">
            <h4 class="p-b-7">
              <a href="{{asset('assets/blog-detail.html')}}" class="m-text11">
