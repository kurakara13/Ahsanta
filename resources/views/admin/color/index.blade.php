...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Color</h3> </div>
          ...
          <div class="card">
              ...
              <div class="button-action">
                <ul class="list-inline">
                  <li class="list-inline-item"><button class="btn btn-primary trigger" data-iziModal-open="#modal-add">Create Color</button></li>
                </ul>
              </div>
...
<!-- modal -->
<div id="modal-add" class="iziModal" data-izimodal-title="Create Color" data-izimodal-subtitle="create kategori">
...
<div id="modal-edit" class="iziModal" data-izimodal-title="Edit Color" data-izimodal-subtitle="edit kategori">
